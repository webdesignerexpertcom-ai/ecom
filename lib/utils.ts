...
export function generateWhatsAppLink(product: { name: string; price: number; weight: string }, phoneNumber: string = "91XXXXXXXXXX") {
...
export function generateWhatsAppLinkMulti(cart: any[], totalPrice: number, phoneNumber: string = "91XXXXXXXXXX", appliedCoupon?: string, discount?: number) {
